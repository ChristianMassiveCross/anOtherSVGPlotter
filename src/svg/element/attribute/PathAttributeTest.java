...
public class PathAttributeTest {
	...
	public void moveTo() {
		...
		assertEquals("d='M 100 200 '", PA.toString());
	}
	@Test
	public void lineTo() {
		PathAttribute PA = new PathAttribute();
		PA.lineTo(new Point(333,666));
		assertEquals("d='L 333 666 '", PA.toString());
	}
	@Test
	public void CurveTo() {
		PathAttribute PA = new PathAttribute();
		...
		assertEquals("d='C 1 2 3 4 5 6 '", PA.toString());
	}
	@Test
	public void smoothCurveTo() {
		...
		assertEquals("d='S 11 22 33 44 '", PA.toString());
	}
	@Test
	public void closePath() {
		PathAttribute PA = new PathAttribute();
		PA.closePath();
		assertEquals("d='Z '", PA.toString());
	}
	...
	public void concatPath() {
		...
		PA.closePath();
		assertEquals("d='M 1 2 L 100 200 Z '", PA.toString());
	}
